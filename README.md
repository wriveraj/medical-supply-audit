...
In current role with Zimmer Biomet’s North Atlantic Division, I combine hands on operational expertise with advanced analytics to optimize inventory performance. Designs and manage KPI dashboards, performs demand forecasting, and applies root cause analysis to reduce risk, improve accuracy, and support data driven decision making. His work routinely leverages SAP, Power BI, PostgreSQL, and advanced Excel to translate complex data into actionable insights for leadership and cross functional teams.
